...
static const vrpn_uint16 vrpn_3DCONNEXION_PILOT =  0xc625;		// Changed: 22.01.08, Bilke
static const vrpn_uint16 vrpn_3DCONNEXION_EXPLORER =  0xc627;	// Changed: 22.01.08, Bilke
...
// Changed: 22.01.08, Bilke
vrpn_3DConnexion_Pilot::vrpn_3DConnexion_Pilot(const char *name, vrpn_Connection *c)
  : vrpn_3DConnexion(_filter = new vrpn_HidProductAcceptor(vrpn_3DCONNEXION_VENDOR, vrpn_3DCONNEXION_PILOT), 8, name, c)
{
}

// Changed: 22.01.08, Bilke
vrpn_3DConnexion_Explorer::vrpn_3DConnexion_Explorer(const char *name, vrpn_Connection *c)
  : vrpn_3DConnexion(_filter = new vrpn_HidProductAcceptor(vrpn_3DCONNEXION_VENDOR, vrpn_3DCONNEXION_EXPLORER), 8, name, c)
{
}
